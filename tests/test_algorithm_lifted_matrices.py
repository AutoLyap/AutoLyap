...
def test_compute_e_star_and_nonstar_shape(constant_algorithm):
    E = constant_algorithm.compute_E(1, [(1, 0), ("star", "star")], 0, 0)
    assert E.shape == (4, 6)
