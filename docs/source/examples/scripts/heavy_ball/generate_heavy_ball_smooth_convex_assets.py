#!/usr/bin/env python3
"""Generate heavy-ball smooth-convex sweep data and an SVG plot asset.
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Generate heavy-ball smooth-convex sweep data and SVG plot assets."
    )
    parser.add_argument(
        "--output-dir",
        type=Path,
